...
export class ViewReservacionComponent implements OnInit {
  ...
  public message= "El precio será determinado por el consumo realizado en el local"
  ...
  loadServation(id: string) {
    this.reservationTablesService.getById(id).subscribe((reservation: ReservationTables) => {
      ...
      this.originalCantidadMesasReservada = reservation.cantidadMesasReservada;
